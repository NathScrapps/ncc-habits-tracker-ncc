...
describe('PatientCard', () => {
  ...
  it('calls onClick with patient id when card body is clicked', async () => {
  ...
  it('calls onUnassign with patient id when Unassign button is clicked', async () => {
  ...
  it('disables the unassign button when isUnassigning is true', () => {
    render(
      <PatientCard
        patient={patient}
        onClick={vi.fn()}
