...
describe('PatientHabitsPanel', () => {
  it('shows an empty message when there are no habits', () => {
  ...
  it('renders three chart containers for the three metrics', () => {
    render(<PatientHabitsPanel habits={mockHabits} />)
    expect(screen.getAllByRole('img')).toHaveLength(3)
  })

  it('renders no charts when habits array is empty', () => {
    render(<PatientHabitsPanel habits={[]} />)
